...
public class DealServiceImpl implements DealService {
    ...
    public Deal createDeal(Deal deal) {
        HomeCategory category= homeCategoryRepository.findById(deal.getCategory()
                .getId()).orElse(null);
    ...
    public Deal updateDeal(Deal deal,Long id) throws Exception {
        ...
        HomeCategory category = homeCategoryRepository.findById(deal.
                getCategory().getId()).orElse(null);
